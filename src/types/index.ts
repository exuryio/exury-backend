...
export interface User {
  ...
  email: string;
  /**
   * @description Applicant Id generated by the KYC provider (e.g. Sumsub) for this user, if they have started the KYC process. Used to link the user to their KYC status and answers.
   */
  applicant_id?: string;
  /**
   * @description Review answer provided by the KYC provider for this user, if they have completed the KYC process.
   */
  applicant_review_answer?: string;
  /**
   * @description Review status provided by the KYC provider for this user, if they have completed the KYC process.
   */
  applicant_review_status?: string;
  /**
